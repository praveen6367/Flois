...
export function VideoStoriesSection({
  ...
  return (
    <section className="relative w-full bg-[#FFFFFF] text-[#111111] py-20 sm:py-28 lg:py-32 overflow-hidden border-b border-[#E8E6DF]">
      {/* Subtle Botanical Ambient Lighting Atmosphere */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[500px] bg-[#F8F6F3] rounded-full blur-3xl pointer-events-none -z-10" />
