...
export function ShopHero() {
  ...
  return (
    <section className="relative w-full bg-[#FAF9F5] py-16 sm:py-20 overflow-hidden border-b border-[#E8E6DF]">
      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-16 relative z-10 text-center">
        ...
        <motion.span
          ...
          className="text-[11px] font-sans font-semibold uppercase tracking-[0.25em] text-[#4B644C] block mb-3"
        >
        ...
        <motion.h1
          ...
          className="font-serif text-4xl sm:text-6xl font-normal leading-[1.08] tracking-tight text-[#121412] max-w-2xl mx-auto mb-4"
        >
        ...
        <motion.p
          ...
          className="text-sm sm:text-base font-sans text-[#4A4E4A] font-light leading-relaxed max-w-xl mx-auto mb-8"
        >
        ...
        >
          <a
            href="#products"
            className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-[#141C15] text-white text-xs font-sans uppercase tracking-[0.2em] font-semibold hover:bg-[#4B644C] transition-colors duration-300 shadow-md"
          >
