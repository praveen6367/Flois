...
export function ShopBenefits() {
  ...
  return (
    <section className="relative w-full bg-[#FAF9F5] py-16 sm:py-24 border-b border-[#E8E6DF]">
          ...
          {BENEFITS.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="h-14 w-14 rounded-full bg-[#F5F3EC] border border-[#E8E6DF] flex items-center justify-center text-[#4B644C]">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs font-sans text-[#787E78] font-light leading-relaxed">
                    {item.desc}
                  </p>
                </div>
              </motion.div>
